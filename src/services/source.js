...
export const requestAuthGetOrderSources = async (page) => {
    try {
        const res = await request.get('/manages/sources/orders', {
            params: {
                page,
            },
        });
...
export const requestAuthDestroyOrderSource = async (id) => {
    try {
        const res = await request.delete('/manages/sources/orders/destroy', {
            params: {
                id,
            },
        });
