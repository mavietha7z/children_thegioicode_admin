...
import { requestAuthCreateCloudServerImage } from '~/services/cloudServer';

function CreateImage({ open, setOpen, callback, setCallback }) {
    ...
    const handleCreateImage = async (values) => {
        ...
        const result = await requestAuthCreateCloudServerImage(data);
    ...
    return (
        ...
        >
            <Form layout="vertical" form={form} onFinish={handleCreateImage} initialValues={{ priority: 1 }}>
                <Row gutter={16}>
                    <Col md={12} xs={24}>
                        <Form.Item
                            name="title"
