...
import { IconArrowLeft, IconFileDescription, IconNote, IconTrash } from '@tabler/icons-react';
...
function NotificationEmail() {
    ...
    useEffect(() => {
        document.title = 'Quản trị website - Danh sách thông báo email';

        const fetch = async () => {
            setLoading(true);
            const result = await requestAuthGetNotifications('Email', page);
        ...
        },
        {
            ...
            render: (data, record) => (
                <Flex align="center" gap={12}>
                    ...
                    <Tooltip title={`Note: ${data.note}`}>
                        <Button size="small" className="box-center" type="primary">
                            <IconNote size={18} />
                        </Button>
                    </Tooltip>
                    <Tooltip title="Xoá">
